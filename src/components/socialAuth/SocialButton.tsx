...
const brandColors: Record<SocialProvider, { bg: string; hover: string; text: string }> = {
  ...
  facebook: { bg: '#1877F2', hover: '#166fe5', text: '#ffffff' },
  github: { bg: '#24292e', hover: '#1b1f23', text: '#ffffff' },
  twitter: { bg: '#1DA1F2', hover: '#1a91da', text: '#ffffff' },
  linkedin: { bg: '#0A66C2', hover: '#095196', text: '#ffffff' },
  apple: { bg: '#000000', hover: '#1a1a1a', text: '#ffffff' },
  microsoft: { bg: '#00A4EF', hover: '#0078D4', text: '#ffffff' },
};
...
export const SocialButton = React.forwardRef<HTMLButtonElement, SocialButtonProps>((
  ...
  const customClassName = `${styles.socialButton} ${styles[provider]} ${className || ''}`;
